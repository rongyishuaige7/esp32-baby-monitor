...
![历史 ESP32 监测原型，2026-04-08](assets/photos/historical-prototype-overview.jpg)
...
```text
桌面原工程的当前工作区版本已裁决为公开候选来源；历史 Git HEAD 仅作差异基线
...
- 公开候选从桌面原工程的**当前工作区**隔离复制；原目录及其历史 Git 记录保持不写入。
- 原工程历史 HEAD 为 `4d108b2167c81b242632230526ac38b52364bcb5`。公开前工作区相对该 HEAD 存在源码、配置和 README 差异；当前工作区被裁决为发布候选，历史 HEAD 仅作为可审计基线。
