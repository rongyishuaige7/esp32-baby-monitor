...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype-overview.jpg` | 2026-04-08 | EXIF/GPS and other image metadata removed; resized from a copy | Historical prototype overview. |
| `assets/photos/historical-prototype-detail.jpg` | 2026-04-08 | EXIF/GPS and other image metadata removed; resized from a copy | Historical prototype detail. |
| `hardware/eda/schematic.pdf` | Export supplied 2026-07-18 | PDF metadata removed from a copy | Historical schematic export. It does not resolve the HC-SR04 5 V ECHO level-shifting risk; follow HARDWARE.md before any future bench work. |
